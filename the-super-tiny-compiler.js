 ...
 * parse raw code into AST (representation code)
 *
 * 2. *Transformation* takes this abstract representation and manipulates(transformed) to do
 *    whatever the compiler wants it to.
 *
 * 3. * * takes the transformed representation of the code and
 ...
 *   }
 *
 * insert, remove or modify node in AST
 ...
 * traverse through(穿过) them. This traversal process goes to each node in the AST
 * depth-first.
 *
 *   {
 *     type: 'Program',
